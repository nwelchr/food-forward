...
import {deleteItem, updateCartItem, deleteCartItem} from "../../actions/index";
...
class CheckoutItem extends React.Component {
    ...
    delete() {
        this
            .props
            .deleteCartItem(this.props.user._id, this.props.item._id);
    }
        ...
        return (
            <li className="checkout-item">
                ...
                <div className="checkout-quantity">
                    <div onClick={() => this.update(-1)} className="co-decriment">&#9664;</div>
                    <div className="co-num">{amount}</div>
                    <div onClick={() => this.update(1)} className="co-increment">&#9654;</div>
                </div>
